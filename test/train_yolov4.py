...
from utils.yolov4.dataloader import yolo_dataset_collate, YoloDataset
from utils.yolov4.yolo_training import YOLOLoss,Generator
...
def fit_one_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    torch.save(model.state_dict(), 'checkpoints/yolov4_Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_loss/(epoch_size_val+1)))
...
if __name__ == "__main__":
    ...
    annotation_path = '../build/train.txt'
    #-------------------------------#
    #   获得先验框和类
    #-------------------------------#
